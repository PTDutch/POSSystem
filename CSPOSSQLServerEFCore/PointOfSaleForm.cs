...
namespace CSPOSSQLServerEFCore
{
    public partial class PointOfSaleForm : Form
    {
        ...
        private void PointOfSaleForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                result = MessageBox.Show(this, msg, caption, btn, ico); //ถ้ายิงbarcodeมาแล้วจะถาม
        ...
        private void generateCustomSalesID() //เขียนโค้ดสร้างเลขที่ใบเสร็จแบบกดหนดเเอง
        {
            ...
            //เช็คว่ามีค่า null มั้ยถ้าไม่มีค่ามูลกำหนดเป็นหนึ่ง แต่ถ้ามีข้อมูลMAXก็มาบวกเพิ่มหนึ่ง
            if (group != null)
            {
